    ...
    >
      <div className="flex flex-row">
        <input
          ...
          maxLength={25}
          required
          className={"bg-neutral-100 placeholder:text-neutral-400 text-black text-lg p-2 rounded-lg h-11 flex-grow max-w-[calc(100vw-12rem)] cs:max-w-[14rem]" + (eventTitle.length >= 25 ? " border-red-500" : "")}
        />
        <input
          type="date"
          value={eventDate}
